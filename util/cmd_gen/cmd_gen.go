...
func GenCmd() {
	...
	fmt.Fprintln(&buf, "// Code generated by github.com/fdvky1/wabot-go DO NOT EDIT.")
		...
		for _, f := range pack.Files {
			for name, object := range f.Scope.Objects {
				if object.Kind == ast.Fun {
					if !strings.Contains(name, "RunFunc") && name != "GenerateAllCommand" && strings.Contains(name, "Command") {
